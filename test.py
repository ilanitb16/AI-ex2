...
def main():
    ...
    game_configurations = [
        ...
        , (200, [1, 2, 1, 2, 1, 2, 1, 2], "test1")
        , (200, [3, 3, 3, 3, 3, 4, 4, 4, 4, 4], "test2")
        , (200, [1, 4, 2, 3, 4, 1, 3, 2, 4, 1], "test3")
        , (200, [1, 2, 3, 1, 2, 3, 1, 2, 3, 1, 2, 3, 1, 2, 3], "test4")
        , (200, [1, 4, 4, 2, 2, 3, 3, 1, 1, 4, 4, 2, 2, 3, 3], "test5"),
        (30, [1, 2, 1, 2, 3], "test6")
        , (30, [4, 3, 4, 3, 4], "test7")
        , (30, [2, 2, 3, 3, 4], "test8")
        , (30, [1, 1, 1, 2, 2], "test9")
